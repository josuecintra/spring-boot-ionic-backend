...
public class Cliente implements Serializable {
	...
	// Como perfil é um Integer, usaremos o toEnum() do Perfil para buscar a String dele
	public Set<Perfil> getPerfis() {
		// Aula "68 Salvando perfis de usuário na base de dados" +/- 4 min. explica esta lambda
